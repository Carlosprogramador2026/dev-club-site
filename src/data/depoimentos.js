...
const ADRIANO_COUTINHO = {
  ...
  texto:
    "Meu nome é Adriano Coutinho e minha trajetória na programação começou com muitas dúvidas e desafios. No início, eu não imaginava que seria possível construir uma carreira como freelancer, mas decidi investir no aprendizado e me dedicar todos os dias. Estudando desenvolvimento de sistemas, criação de sites profissionais e soluções com Agentes de Inteligência Artificial, comecei a conquistar meus primeiros clientes e a desenvolver projetos cada vez mais completos. Com o passar do tempo, minha experiência aumentou, as indicações começaram a surgir e consegui atender empresas de diferentes segmentos. Ao longo dessa jornada, alcancei aproximadamente R$ 98 mil em faturamento com projetos de programação, incluindo sistemas personalizados, desenvolvimento de sites e automações com Inteligência Artificial. Mais importante do que o resultado financeiro foi perceber que a tecnologia me proporcionou liberdade para trabalhar com o que gosto, desenvolver soluções que geram valor para meus clientes e construir uma carreira baseada em conhecimento, dedicação e aprendizado contínuo. Hoje continuo estudando, acompanhando as novas tendências em IA e ajudando empresas a modernizar seus processos por meio da tecnologia.",
...
const SYLVANA_RIBEIRO = {
  ...
  texto:
    "Meu nome é Sylvana Monteiro Paes Ribeiro e minha trajetória na programação foi marcada por muitos desafios, dedicação e perseverança. No início, achei que nunca conseguiria aprender. Muitas vezes pensei em desistir, pois os códigos pareciam impossíveis de entender e a tecnologia parecia distante da minha realidade. Foi nesse momento que recebi o maior incentivo da minha vida: meu filho acreditou em mim quando eu mesma já estava perdendo as esperanças. Com paciência, apoio e muita motivação, continuei estudando todos os dias, praticando e desenvolvendo projetos reais. Aos poucos, aquilo que parecia impossível começou a fazer sentido. Com o conhecimento adquirido, comecei a atuar como freelancer, desenvolvendo sites profissionais, sistemas personalizados e soluções tecnológicas para empresas. Mas foi na criação de Agentes de Inteligência Artificial que encontrei minha maior oportunidade de crescimento. Esse mercado transformou completamente minha carreira e me permitiu alcançar resultados que eu jamais imaginei. Ao longo dos projetos realizados, ultrapassei a marca de R$ 65 mil em faturamento. Mais do que o valor financeiro, conquistei independência, confiança e a certeza de que nunca é tarde para aprender uma nova profissão. Hoje tenho orgulho da minha história e sou a prova de que, com determinação, estudo e apoio das pessoas certas, é possível transformar dificuldades em grandes conquistas. A programação mudou a minha vida, e eu acredito que ela também pode mudar a vida de muitas outras pessoas.",
